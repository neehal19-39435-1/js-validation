...
$fname = $lname = $gender = $religion  = $dob= $paddress = $peraddress = $phone = $email = $weblink = $username =$password = "";
...
{
$firstNameErr = "Exceeding limit";
$flag = true;
}

if(strLen($_POST["lname"])>10)
{
$lastNameErr = "Exceeding limit";
$flag = true;
}
if(strLen($_POST["gender"])>10)
{
$genderErr = "Exceeding limit";
$flag = true;
}
if(strLen($_POST["dob"])>10)
{
$dateOfbirthErr = "Exceeding limit";
$flag = true;
}
if(strLen($_POST["religion"])>10)
{
$religionErr = "Exceeding limit";
$flag = true;
}
if(strLen($_POST["username"])>50)
{
$userNameErr = "Exceeding limit";
$flag = true;
}

if(strLen($_POST["password"])>20)
{
$passWordErr = "Exceeding limit";
$flag = true;
}
...
<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="POST" name = "reg" onsubmit="return isValid()";>
	...
	<span id="dateOfbirthErr" style="color:red;"></span>
